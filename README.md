...
PaperNet is a research discovery tool. Give it a topic keyword, and it finds the most relevant paper, then builds a connected net of related papers around it — linked by citations and by semantic (abstract) similarity — so you can visually explore a research area instead of reading one paper at a time. An AI chat panel sits alongside the graph so you can ask questions about the net and jump straight to any paper it mentions.

Built as a Capstone data engineering project.
